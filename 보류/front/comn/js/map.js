...
function addMarker(item, index){
	...
	let img = {
		...
		// 	2020-11-23 #수정 (숫자 붙은 마커 사용 시 아래 45, 44 크기로 사이즈 수정 필요
		// 	size: new kakao.maps.Size(45,44)
	};

	// 2020-11-02 #참고 마커종류 설명
	/*
		marker.png - 일반 마커
		markerAirplane.png - 스크랩 마커
		markerFood.png - 음식점 마커
		markerBuilding.png - 숙박 마커
		markerFlag.png - 관광지 마커
		marker1.png - 숫자 붙은 마커.(marker1, marker2, marker3, ...)
		markerAirplane1.png - 숫자 붙은 스크랩 마커
		markerFood1.png - 숫자 붙은 음식점 마커
		markerBuilding1.png - 숫자 붙은 숙박 마커
		markerFlag1.png - 숫자 붙은 관광지 마커
	*/
